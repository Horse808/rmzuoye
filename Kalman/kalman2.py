...
plt.plot(days[-30:],prices[-30:],'b-',linewidth=1.5,label='lishijiage')
plt.plot(future_days,future_10,'r--',linewidth=1.5,marker='o',markersize=4,label='weilaiyuce')
plt.axvline(x=days[-1],color='gray',linestyle='--',alpha=0.5)
plt.xlabel('day')
plt.ylabel('price')
plt.title('future 10 days')
plt.legend()
